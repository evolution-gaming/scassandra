...
object DecodeByIdx {
  ...
  implicit val boolDecodeByIdx: DecodeByIdx[Boolean] =
    (data: GettableByIndexData, idx: Int) => data.getBool(idx)

  implicit val strDecodeByIdx: DecodeByIdx[String] =
    (data: GettableByIndexData, idx: Int) => data.getString(idx)

  implicit val shortDecodeByIdx: DecodeByIdx[Short] =
    (data: GettableByIndexData, idx: Int) => data.getShort(idx)
